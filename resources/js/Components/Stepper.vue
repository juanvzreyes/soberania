      ...
      >
        <div class="flex flex-col items-center flex-1">
          ...
          <span
            ...
            :class="index <= currentStep ? 'text-green-600 dark:text-green-400' : 'text-gray-400'"
          >
            {{ step }}
          </span>
        </div>
...
const getStepClasses = (index) => {
  if (index < props.currentStep) {
    ...
    return 'bg-white dark:bg-slate-800 border-green-600 text-green-600 dark:text-green-400';
  } else {
